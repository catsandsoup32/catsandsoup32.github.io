          ...
          {%- unless child.title == 'divider' -%}
            {
              ...
              {%- if child.permalink contains "/notes/" -%}{%- assign url = "/notes/" -%} {%- else -%}{%- assign url = child.url -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains "/notes/" -%}{%- assign url = "/notes/" -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
